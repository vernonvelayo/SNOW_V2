...
plot 	"commands.csv" using 1:2 with lines title "uWheel[0]" lw 3, "commands.csv" using 1:3 with lines title "uWheel[1]" lw 3, "commands.csv" using 1:4 with lines title "uWheel[2]" lw 3, "commands.csv" using 1:5 with lines title "uWheel[3]" lw 3
