...
plot 	"joint_state.csv" using 1:10 with lines title "pArmActual[0]" lw 3, "target.csv" using 1:2 with lines title "pArmTarget[0]" lw 3, "target.csv" using 1:10 with lines title "aTargetAngle[0]" lw 3,"joint_state.csv" using 1:18 with lines title "pState"  lw 3
